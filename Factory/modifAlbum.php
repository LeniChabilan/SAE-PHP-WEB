...
$updateAlbum = "UPDATE Album SET nomAlbum = :nomAlbum, AnneeAlbum = :AnneeAlbum, imageAlbum = :imageAlbum, nomProducteur = :nomProducteur, artisteId = :artisteId WHERE albumId = :albumId";
$stmtAlbum = $file_db->prepare($updateAlbum);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nom'])) {
    ...
    $stmtAlbum->bindParam(':albumId', $id_album);
