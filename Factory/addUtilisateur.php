...
$insertUtilisateur = "INSERT INTO Utilisateur (nomUtilisateir, emailUtilisateur, MDPutilisateur, roleUtilisateur, DdN, numTel) VALUES (:nomUtilisateur, :emailUtilisateur, :MDPutilisateur, :roleUtilisateur, :DdN, :numTel)";
$stmtUtilisateur = $file_db->prepare($insertUtilisateur);
