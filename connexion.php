...
<html lang="fr">
  ...
  <body class="light">
    ...
    <header>
      ...
      <div class="droite">
        <button type="button" id="bouton_se_connecter">Se connecter</button>
        </ul>
      </div> 
    </header>
            ...
            <div class="card">
                ...
                <form class="form-horizontal" role="form" method="POST" action="">
                    ...
                    <div class="field">
                        ...
                        <div class="col-sm-10">
                        <input type="email" name="emailUtilisateur" size="50" class="input-field" placeholder="Nom Utilisateur">
                    ...
                    <div class="field">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="motDePasse" size="50" class="input-field" placeholder="Mot De Passe">
